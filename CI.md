...
**Project:** gh/graybear-io/gbe
**Dashboard:** https://app.circleci.com/pipelines/gh/graybear-io/gbe
...
```json
{
  "projectSlug": "gh/graybear-io/gbe",
  "gitRemoteURL": "git@github.com:graybear-io/gbe.git",
  "workspaceRoot": "/Users/bear/projects/gbe",
  "branch": "main"
}
```
